...
pasta_aco = "/home/leggen-assis/Documents/faculdade/TCC/implementacao/3RDF/Tabelas/ACOFLxFLGA-RG/ACO"
pasta_ga = "/home/leggen-assis/Documents/faculdade/TCC/implementacao/3RDF/Tabelas/ACOFLxFLGA-RG/GA"
...
for graph_name in dados_aco.keys():
    if graph_name in dados_ga:
        ...
        nova_linha = {
            ...
            "LB": linha_aco["LB"],
            "UB": linha_aco["UB"],
            "Melhor Fitness (ACOFL)": linha_aco["Melhor Fitness"],
            "Melhor Fitness (FLGA)": linha_ga["Melhor Fitness"]
        }
